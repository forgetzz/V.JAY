  ...
  return (
    <>
      ...
      <div className="nb-root">
        ...
        {/* ── Mobile Drawer ── */}
        <nav className={`nb-drawer ${drawerOpen ? 'open' : ''}`} aria-label="Mobile menu">
          ...
          <button className="nb-drawer-cta" onClick={() => setDrawerOpen(false)}>
            Book Home Visit
          </button>
        ...
        {/* ── Main Navbar ── */}
        <header className={`nb-nav ${scrolled ? 'scrolled' : ''}`} role="banner">
          ...
          <a className="nb-logo" href="#" aria-label="Razor & Co Home">
            ...
            <div className="nb-logo-text">
              <span className="nb-logo-name">lorem &amp; ipsum</span>
          ...
          <div className="nb-actions">
            <a className="nb-phone" href="tel:+6281234567890" aria-label="Call us">
